      ...
      <Row>
        <Col sm='6'>
          ...
          <p>We present a curated database of the best campsites in the
             vast woods and backcountry of the World Wid Wilderness.
             We increase access to adventure for the public while
             promoting safe and respectful use of resources expert
             wilderness trekkers on our staff personally verify each
             campsite to make sure that they are up t standards. We
        ...
        <Col>
          <Card className='bg-light mt-3'></Card>
          <CardBody>
            <blockquote className='blockquote'>
              <p>
              I will not follow where the path may lead, but I
              will go where there is no path, leave
              a trail.
              </p>
              <footer className='blockquote-footer'>
              Muriel Strode,{' '}
                <cite title='Source Title'>
                    "Wind-Wafted Wild Flowers" -Court,
                    1903
                </cite>
              </footer>
            </blockquote>
